...
namespace OHOS {
    ...
    void from_json(const nlohmann::json &jsonObject, ClassInfo &classInfo) {
        ...
        GetValueIfFindKey<std::vector<MethodInfo>>(jsonObject,
                                                   jsonObjectEnd,
                                                   "methods",
                                                   classInfo.methods,
                                                   JsonType::ARRAY,
                                                   ...
                                                   ArrayType::OBJECT);
        parseResult = 0;
        GetValueIfFindKey<std::vector<FieldInfo>>(jsonObject,
                                                  jsonObjectEnd,
                                                  "fields",
                                                  classInfo.fields,
                                                  JsonType::ARRAY,
    ...
    void from_json(const nlohmann::json &jsonObject, MethodInfo &methodInfo) {
        ...
        int32_t parseResult = 0;
        GetValueIfFindKey<std::vector<Argument>>(jsonObject,
                                                 jsonObjectEnd,
                                                 "args",
                                                 methodInfo.args,
                                                 JsonType::ARRAY,
                                                 ...
                                                 ArrayType::OBJECT);
        parseResult = 0;
        GetValueIfFindKey<ReturnObject>(jsonObject,
                                        jsonObjectEnd,
                                        "returnObject",
    ...
    void from_json(const nlohmann::json &jsonObject, ReturnObject &returnObject) {
        ...
        returnObject.arrayDimension = jsonObject.at("arrayDimension").get<int32_t>();
    ...
    MethodFlag GetReturnType(int32_t type) {
        int32_t flag = static_cast<int32_t>(MethodFlag::FLAG_JNI_METHOD_RETURN_VOID) - 1;
