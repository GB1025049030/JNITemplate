...
#define JAVA_BEAN_InstalledFormResourceInfo \
    "ohos/bundlemgr/InstalledFormResourceInfo"
...
class TransformInstalledFormResourceInfo
    : public Transform<InstalledFormResourceInfo> {
    using Transform::Transform;
...
class TransformPackageInstalledStatus
    : public Transform<PackageInstalledStatus> {
    using Transform::Transform;
...
enum class MethodCode_OHOS_BUNDLEMGR {
    ...
    // sign:
    // (Lohos/bundlemgr/InstallShellInfo;)Lohos/bundlemgr/PackageInstalledStatus;
