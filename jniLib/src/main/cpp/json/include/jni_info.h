...
namespace OHOS {
    ...
    struct JNIMethodInfo {
        ...
        JNIMethodInfo(jmethodID &methodID, jclass &classID, ReturnObject &returnObject) : methodID(
                methodID), classID(classID), returnObject(returnObject) {}
    };
    ...
    struct JNIFieldInfo {
        ...
        JNIFieldInfo(jfieldID &fieldId, jclass &classID, FieldInfo &fieldInfo) : fieldId(
                fieldId), classID(classID), fieldInfo(fieldInfo) {}
    };
